<%-- 
    Document   : CarteleraAuditorio
    Created on : 24/10/2020, 8:49:39 p. m.
    Author     : Windows 10
--%>
...
<html>
    <head>
        ...
        <title>CARTELERA AUDITORIO</title>
    ...
    <body>
        ...
        <br><br>
            ...
            <br><br><br>
             <center><h2>Cartelera auditorio.</h2></center>
                    ...
                    <div class="container">	
                            ...
                            <div class="container-fluid">
                                    ...
                                    MisConsultas misConsultas = new MisConsultas();
                                         ...
                                         for(Evento event : misConsultas.consultaEventoAuditorio()){

                                        
                                        
                                        out.println("<div class='col-xs-6 col-sm-6 col-md-6 col-lg-6'>");	
                                            out.println("<form action='MostrarInfoAuditorio.jsp'>");
