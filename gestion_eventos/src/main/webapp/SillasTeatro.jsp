<%-- 
    Document   : SillasTeatro
    Created on : 24/10/2020, 9:16:13 p. m.
    Author     : Windows 10
--%>
            ...
            <div class="container fondo_info">
                <div class="form-row">
                    ...
                    <%
                        ...
                        out.println("<input type='hidden' id='sillas' value='SillasTeatro'>");
                ...
                <table  border="1">
                    <tbody id="tabla_sillas" >
                        ...
                        <tr>
                            ...
                            <td id='<%=id%>' class='ocupada' name="ocupada" ><img  src="imagenes/silla_ocupada.png"> </td>
                                <%
                                            bandera = true;
                                        }
                                    }
                                    if (!bandera) {%>
                            <td id='<%=id%>' class='desocupada' name="desocupada"><img  src="imagenes/silla_desocupada.png"></td>
                                <%bandera = false;
                                        }
