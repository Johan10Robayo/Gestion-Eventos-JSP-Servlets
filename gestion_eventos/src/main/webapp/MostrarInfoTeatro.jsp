<%-- 
    Document   : MostrarInfoTeatro
    Created on : 24/10/2020, 9:15:15 p. m.
    Author     : Windows 10
--%>
...
<html>
    <head>
        ...
        <title>Informaci&oacute;n teatros.</title>
                ...
                <center>
                    ...
                    <article> 
                        <%  MisConsultas misConsultas = new MisConsultas();
                           ...
                           <center> <img class="img-responsive" src="<%= event.getPoster()%>" width="600" height="600"/> </center>   
