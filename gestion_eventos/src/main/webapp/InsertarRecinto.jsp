<%-- 
    Document   : InsertarRecinto
    Created on : 5/11/2020, 2:54:36 p. m.
    Author     : santi
--%>
    ...
    <body>
        ...
        <section class="main row">
            <div class="col-lg-12">	                 
                ...
                <%
                    Recinto recin = new Recinto(request.getParameter("nombrerecinto"), request.getParameter("tiporecinto"));
                    ...
                    sql = "insert into recinto (nombre,tipo) value (";
                    sql = sql + "'" + recin.getNombre() + "',";
                    sql = sql + "'" + recin.getTipo() + "'";
                    sql = sql + ")";
                    ...
                    if (inserto == true) {
                        out.println("<h1>RECINTO " + recin.getNombre() + " CREADO CON ÉXITO</h1>");
                    } else {
                        out.println("<h1>Error al crear el recinto</h1>");
                    }
                    out.print("</div>");
                    out.print("</section>");
                    out.print("</div>");
