<%-- 
    ...
    Created on : 5/11/2020, 11:11:26 p. m.
    Author     : Windows 10
--%>
                    ...
                    <div class="container-fluid">
                        ...
                        <%
                            ...
                            for (Usuario usuario : misConsultas.consultaUsuario()) {
                                ...
                                out.println("<center><label>Numero de Documento:</label><input disabled='disabled' value='" + usuario.getNumero_documento() + "'></center>");
                                out.println("<center><label>Tipo de documento:</label><input disabled='disabled' value='" + usuario.getTipo_documento() + "'></center>");
                                out.println("<center><label>Nombre:</label><input disabled='disabled' value='" + usuario.getNombre() + "'></center>");
                                out.println("<center><label>Correo:</label><input disabled='disabled' value='" + usuario.getCorreo() + "'></center>");
                                out.println("<center><label>Celular:</label><input disabled='disabled' value='" + usuario.getCelular() + "'></center>");
                                out.println("<center><label>ID:</label><input disabled='disabled' value='" + usuario.getId() + "'></center>");
                                out.println("<center><label>Usuario:</label><input disabled='disabled' value='" + usuario.getUsuario() + "'></center>");
                                out.println("<center><label>Tipo:</label><input disabled='disabled' value='" + usuario.getTipo() + "'></center>");
                                out.println("<center><label>Password:</label><input disabled='disabled' value='" + usuario.getPassword() + "'></center>");
