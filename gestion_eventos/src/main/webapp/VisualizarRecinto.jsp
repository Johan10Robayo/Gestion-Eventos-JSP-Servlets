<%-- 
    Document   : VisualizarRecinto
    Created on : 5/11/2020, 3:08:45 p. m.
    Author     : santi
--%>
...
<html>
    <head>
        ...
        <title>VISUALIZAR RECINTOS</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <%
                            ...
                            for (Recinto recinto : misConsultas.consultaRecinto()) {
                                ...
                                out.println("<center><label>ID:</label><input disabled='disabled' value='" + recinto.getId() + "'></center>");
