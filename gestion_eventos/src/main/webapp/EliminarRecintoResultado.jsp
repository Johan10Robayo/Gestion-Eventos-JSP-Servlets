<%-- 
    Document   : EliminarRecintoResultado
    Created on : 5/11/2020, 3:39:23 p. m.
    Author     : santi
--%>
        ...
        <section class="main row">
            <div class="col-lg-12">
                <%
                    ...
                    sql = "DELETE FROM recinto WHERE nombre='" + request.getParameter("nombrerecinto") + "'";
                    ...
                    if (inserto == true) {
                        out.println("<h1>RECINTO " + request.getParameter("nombrerecinto") + " ELIMINADO CON ÉXITO</h1>");
                    } else {
