<%-- 
    Document   : ActualizarRecinto
    Created on : 5/11/2020, 4:18:25 p. m.
    Author     : santi
--%>
...
<html>
    <head>
        ...
        <title>ACTUALIZAR RECINTOS</title>
    ...
    <body>
        ...
        <br><br><br>
    <center><h2>Actualizar recinto.</h2></center>
    <div class="container">
                    ...
                    <div class="container-fluid">
                        ...
                        <%
                            ...
                            for (Recinto recinto : misConsultas.consultaRecinto()) {
                                ...
                                out.println("<form action='ActualizarRecintoResultado.jsp' method='get' >");
                                out.println("<h4>" + recinto.getNombre() + "</h4>");

                                out.println("<center><label>Nombre:</label><input  value='" + recinto.getNombre() + "' name='nombrerecinto'></center>");
                                out.println("<center><label>ID:</label><input   value='" + recinto.getId() + "' name='idrecinto' ></center>");

                                out.println("<select class='form-control' name='tiporecinto' id='tiporecinto'>");
                                out.println("<option value='Teatro'>Teatro</option>");
                                out.println("<option value='Auditorio'>Auditorio</option>");
                                out.println("</select>");

                                out.println("<center><input class='btn btn-info' type='SUBMIT' value='Actualizar recinto.'></center>");
                                out.println("</form>");
                                out.println("</div><br>");
