<%-- 
    Document   : ActualizarRecintoResultado
    Created on : 5/11/2020, 5:43:50 p. m.
    Author     : santi
--%>
...
<html>
    <head>
        ...
        <title>Actualizar recinto.</title>
    ...
    <body>
        ...
        <section class="main row">
            <div class="col-lg-12">   
                <%
                    int res = 0;
                    int id_recinto = Integer.parseInt(request.getParameter("idrecinto"));
                    ...
                    sql = "UPDATE recinto set nombre='" + request.getParameter("nombrerecinto") + "',tipo='" + request.getParameter("tiporecinto") + "' where id=" + id_recinto;
                    ...
                    if (inserto == true) {
                        out.println("<h1>RECINTO " + request.getParameter("nombrerecinto") + " ACTUALIZADO CON ÉXITO</h1>");
                    } else {
                        out.println("<h1>Error al eliminar el recinto</h1>");
                    }
                    out.print("</div>");
                    out.print("</section>");
                    out.print("</div>");
