<%-- 
    ...
    Created on : 5/11/2020, 11:10:50 p. m.
    Author     : Windows 10
--%>
                    ...
                    <div class="container-fluid">
                        ...
                        <%
                            ...
                            for (Usuario usuario : misConsultas.consultaUsuario()) {
                                ...
                                out.println("<form action='EliminarUsuarioResultado.jsp' method='get' >");
                                out.println("<h4>" + usuario.getNombre() + "</h4>");

                                out.println("<center><label>Nombre:</label><input type='hidden'  value='" + usuario.getNombre() + "' name='nombreusuario'></center>");
                                out.println("<center><label>ID:</label><input  disabled='disabled' value='" + usuario.getId() + "' name='idusuario' ></center>");
                                out.println("<center><label>Numero de Documento:</label><input disabled='disabled' value='" + usuario.getNumero_documento() + "' name='numero_documento'></center>");
                                out.println("<center><input type='hidden' value='" + usuario.getNumero_documento() + "' name='numerodocumento'></center>");

                                out.println("<center><input class='btn btn-info' type='SUBMIT' value='Eliminar usuario.'></center>");
                                out.println("</form>");
                                out.println("</div>");
